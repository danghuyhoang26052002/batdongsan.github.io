            ...
            <div class="double-scroll">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="text-center"><img class="text-center" src="{{asset("storage/".$a->images)}}" alt="" style=" height:80px; margin-bottom: 10px;" class="img-responsive"></td>
                        <td class="text-center">
                            <a href="{{route('route_BackEnd_Users_Detail',$a->id)}}" >
                            ...
                            <a href="{{route('route_BackEnd_Users_Remove',$a->id)}}" onclick="return confirm('Bạn chắc chắn muốn xóa chứ ?')">
